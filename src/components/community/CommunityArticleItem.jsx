  ...
  return (
    <div className="CommunityArticleItem">
      ...
      <div className="CommunityArticleItem__body">
        <Link
          className="CommunityArticleItem__title"
          to={`${PATH_COMMUNITY}/${articleId}`}
        >
          {title}
        </Link>
        <Link
          className="CommunityArticleItem__content"
          to={`${PATH_COMMUNITY}/${articleId}`}
        >
          {content}
        </Link>
      ...
      <div className="CommunityArticleItem__foot">
        <ArticleCntList
          ...
          commentsCnt={comments_cnt}
        />
        <span className="CommunityArticleItem__created-time">
          {strToDate(created_at)}
        </span>
      </div>
    </div>
  );
